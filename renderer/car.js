...
(function () {
  ...
  const STARTER = [
    ...
    '',
    'print("Поехали!")',
    'strip(0, 0, 255, 0)    # первый диод — зелёный',
    'show()                 # показать ленту',
    '',
    'def hit():',
    '    print("В нас попали!")',
    '    strip(0, 255, 0, 255)   # маджента',
    '    show()',
    '    servo(CLAW, 120)        # клешня толкает препятствие',
    '    wait(0.4)               # ждём, пока серво доедет',
    '    servo(CLAW, 0)          # вернуть назад',
    '',
    'on_hit(hit)',
    'forever()              # программа живёт, пока не остановишь',
    ''
  ].join('\n');
